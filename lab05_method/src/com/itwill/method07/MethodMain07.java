...
public class MethodMain07 {
	...
	public static void main(String[] args) {
		...
		total = addAll(1, 100); // 아규먼트 2개 => length = 2
		System.out.println("total = " + total);
	...
	// 가변길이 인수를 갖는 메서드를 호출할 때에는 아규먼트 개수에 제한이 없음.
	// - 아규먼트를 전달하지 않아도 됨. 
	...
	public static int calculate(String op, int...values) { 	// "+", "*" => 문자열이므로 String.
															//  values는 int타입, 가변길이 인수인 'int...values'를 맨 뒤에 입력.
		int result = 0;
