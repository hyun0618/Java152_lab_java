 ...
 * 
 * 필수요소: 리턴타입 메서드이름() {} => []는 생략 가능(수식어, 파라미터 선언 ...) 
 *   - 수식어 생략 가능
...
/*		int add(int x, int y) {
			return x + y;
		} => 메서드 안에 메서드를 선언할 수 없음. 
*/		
		
	 	double result = add(1.0, 2.0); // add라는 메서드를 불러준다.(호출) 
		...
		System.out.println("divide = " + divide(1, 2)); // double x = 1; double y = 2; => x = 1.0 y = 2.0
