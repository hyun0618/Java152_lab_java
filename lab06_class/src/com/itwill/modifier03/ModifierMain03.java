 ...
 * getter 메서드: private 필드의 값을 리턴하는 메서드. (리턴 타입 필요)
 * setter 메서드: private 필드의 값을 변경하는 메서드. (리턴 void, 파라미터 필요)
 */
...
//		System.out.println("ID: " + member.memberId); // not visible
		...
		Person person = new Person("지현", 23);
		System.out.println("이름: " + person.getName());
		System.out.println("2024년 나이: " + person.getAge());
		
		person.setAge(25);
		System.out.println("2026년 나이: " + person.getAge()); 
