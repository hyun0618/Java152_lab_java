...
public class ClassMain02 {
	...
	public static void main(String[] args) {
		// Score 객체를 생성: 
		Score score1 = new Score(); // 같은 패키지 안에 있으므로 import를 사용하지 않아도 됨. 모든 필드는 기본값으로 생성됨. 
		System.out.println("score1 java = " + score1.java); // java, sql, javascript => score가 가지는 속성, 변수
