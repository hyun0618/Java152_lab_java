...
public class BlogMain implements CreateNotify, UpdateNotify {
	...
	private void initialize() {
		...
		btnDetails = new JButton("상세 보기");
		btnDetails.addActionListener((e) -> showDetailsFrame());
		btnDetails.setFont(new Font("D2Coding", Font.PLAIN, 15));
	...
	private void initializeTable() {	
		List<Blog> blogs = dao.read(); // DAO를 사용해서 DB 테이블에서 검색. 
		resetTable(blogs); // 테이블 리셋.
		
//		// 검색한 내용을 JTable에 보여준다. --> JTable의 테이블 모델을 재설정한다. 
