 ...
 *   - Window 예) C:\study\workspace\Java_152th\lab12_file\data\hello.txt
 ...
 *   - Windows: \
 *   - Linux, MacOS: / 
 *   - 문자열("") 안에서 백슬래시(\)는 특별한 의미(escape 문자열)
 *     예) "\n": 줄바꿈, "\t": 탭, "\s": 공백, "\\" = 백슬래시 
 *     Windows 파일 경로 "C:\\study\\workspace\\ lab12"
 *     Linux, MacOS 파일 경로: "/user/itwill/documents"
 */
...
public class FileMain08 {
	...
	public static void main(String[] args) {
		...
		String path = " C:\\study\\workspace\\Java_152th\\lab12_file"; // Windows 절대 경로 표현법
